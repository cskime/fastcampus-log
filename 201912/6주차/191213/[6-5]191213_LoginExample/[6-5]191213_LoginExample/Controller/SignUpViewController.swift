...
class SignUpViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        signUpButton.addTarget(self, action: #selector(complete(_:)), for: .touchUpInside)
    ...
    @objc private func complete(_ sender: UIButton) {
        if inputForm.canSignUp(), let userInfo = inputForm.fetch() {
