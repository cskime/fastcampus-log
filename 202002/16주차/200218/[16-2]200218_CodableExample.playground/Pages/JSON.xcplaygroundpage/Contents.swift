...
// UserDefaults에 custom object를 저장할 때 encoding해서 저장
//UserDefaults.standard.set(encodedMacBook, forKey: "MacBook")
//let data = UserDefaults.standard.object(forKey: "MacBook") as? Data
//try? JSONDecoder().decode(MacBook.self, from: data!)
//UserDefaults.standard.data(forKey: "MacBook") as? Data
...
let archiveURL = appSupportDir
  .appendingPathComponent("macBookData")  // 파일 이름 추가
  .appendingPathExtension("json")         // 확장자 추가
